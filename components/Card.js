...
const ArticleCard = ({link, title, description, image}) => {
  return (
    <a href={link} style={{"textDecoration":"none"}} target="_blank">
        <article style={{"display":"flex","flexDirection":"column","border-radius":"10px","borderWidth":"1px","width":"290px", "height":"310px","marginTop":"10px", "minHeight":"200px"}} className="card">
