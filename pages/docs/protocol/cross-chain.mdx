...
<picture style={{height: '300px'}}>
    <source srcSet="/diagrams/cross-1-light.png" media="(prefers-color-scheme: light)" />
    <source srcSet="/diagrams/cross-1-dark.png" media="(prefers-color-scheme: dark)" />
    <img src="/diagrams/cross-1-dark.png" alt="Image" className="image" />
</picture>
...
- [Deployment addresses](/docs/integration/deployments)
