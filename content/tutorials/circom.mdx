...
- Your Solidity/Vyper/Fe Verifier should be present in `build/CheckMult/CheckMultVerifier.sol`
...
- Build optimzed graphs of your circuits: https://github.com/iden3/circom-witnesscalc
