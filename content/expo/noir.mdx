...
title: Noir Guide
---
In this guide we'll talk about how to run Noir (PLONK & HONK) Circuits on your iOS/Android devices. We won't go in details about how to [setup and build your Noir Circuits](/tutorials/noir) or how to [make an Expo App](https://docs.expo.dev/tutorial/create-your-first-app/).
